function [PreOA, PreUN] = preTraining(sID, seqCond)
...
sIDDir = [dataDir filesep sIDtxt filesep];
...
PreOA = [sID nanmean(PreOAavgs(:,2:6))];
PreUN = [sID nanmean(PreUNavgs(:,2:6))];

filename = [sIDDir num2str(sID) '_preTraining_' datetime '.mat'];
save(filename);
% get back to Matlab
clear Screen;
ShowCursor;
